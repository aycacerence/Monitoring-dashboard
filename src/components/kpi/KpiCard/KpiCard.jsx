...
function KpiCard({
  ...
  return (
    <Card data-testid="kpi-card" hoverable className="flex h-full flex-col justify-between p-3 lg:p-2.5">
      ...
      <div ref={sparklineRef} className="my-2 min-h-[40px] flex-1 lg:my-0.5 lg:min-h-[20px] xl:min-h-[28px]" style={{ pointerEvents: isEditMode ? 'none' : 'auto' }}>
